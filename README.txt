...
a persistence unit "java-tewPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "java-tew/pom.xml":
...
artifact ("java-tew.war") is already built. You can build
